...
> Click :star:if you like the projeect.Coding questions available [here](#coding-exercise). PDF and Epub versions available at [actions tab](https://github.com/hahmad748/javascript-interview-questions/actions).
...
363. ### How do you map the array values without using map method
     ...
     console.log(cityNames); // ['Islamabad, 'Washington', 'Moscow', 'Singapore', 'Beijing', 'Paris']
     ```
...
364. ### How do you empty an array
     ...
     ```javascript
     let cities = ["Singapore", "Islamabad", "London"];
...
368. ### What are the placeholders from console object
     ...
     ```javascript
     const user = { name: "John", id: 1, city: "Islamabad" };
     console.log(
       "Hello %s, your details %o are available in the object form",
       "John",
       user
     ); // Hello John, your details {name: "John", id: 1, city: "Islamabad"} are available in object
     ```
